...
class ProvisionController: UIViewController {
    ...
    let provisionText: String =
        """
<관계지향적>은 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고
...
② 제1항에 따른 권리 행사는 <관계지향적>에 대해 개인정보 보호법 시행령 제41조제1항에 따라
...
"""
    ...
    fileprivate func setupUI() {
        ...
        provisionTextView.anchor(top: customDismissNavBar.bottomAnchor, leading: view.leadingAnchor, bottom: view.bottomAnchor, trailing: view.trailingAnchor, padding: .init(top: 0, left: 16, bottom: 0, right: 0))
    }
}
