...
//    fileprivate let textColor: UIColor = #colorLiteral(red: 0.1333333333, green: 0.6941176471, blue: 0.9647058824, alpha: 1)
    ...
    lazy var numberOfExposureLabel = UILabel(text: "1234", font: .systemFont(ofSize: 64, weight: .heavy), textColor: textColor, textAlignment: .center, numberOfLines: 1)
//    lazy var resultDiscriptionLabel = UILabel(text: "건이 노출됐습니다", font: .systemFont(ofSize: defaultFontSize, weight: .heavy), textColor: textColor, textAlignment: .center)
    ...
    lazy var actionTipLabel = UILabel(text: "결과창을 탭하여 조치 및 신고를 할 수 있습니다", font: .systemFont(ofSize: 18, weight: .light), textColor: #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1), textAlignment: .center)
